...
public abstract partial class World : IBehaviourExecution {
    ...
    /// 逻辑层所有类的一个字典
    /// </summary>
    protected Dictionary<string, ILogicBehaviour> mLogicBehaviourDic = new Dictionary<string, ILogicBehaviour>();

    /// <summary>
    /// 数据层所有类的一个字典
    /// </summary>
    protected Dictionary<string, IDataBehaviour> mDataBehaviourDic = new Dictionary<string, IDataBehaviour>();

    /// <summary>
    /// 消息层所有类的一个字典
    /// </summary>
    protected Dictionary<string, IMsgBehaviour> mMsgBehaviourDic = new Dictionary<string, IMsgBehaviour>();
    ...
    /// <returns></returns>
    public T GetExitsLogicCtrl<T>() where T : ILogicBehaviour {
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public T GetExitsDataMgr<T>() where T : IDataBehaviour {
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public T GetExitsMsgMgr<T>() where T : IMsgBehaviour {
