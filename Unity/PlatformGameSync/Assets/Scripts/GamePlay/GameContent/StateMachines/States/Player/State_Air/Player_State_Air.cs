...
public class Player_State_Air : Player_State_Base {
    public Player_State_Air(string boolTriggerName, LogicActor_Player logicPlayer, RenderObject_Player renderPlayer, StateMachine stateMachine, string stateName)
